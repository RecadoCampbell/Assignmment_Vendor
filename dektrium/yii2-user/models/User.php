...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function scenarios()
    {
        ...
        return ArrayHelper::merge($scenarios, [
            'register' => ['username', 'email', 'password','address','gender'],
            'connect'  => ['username', 'email'],
            'create'   => ['username', 'email', 'password','address','gender'],
            'update'   => ['username', 'email', 'password','address','gender'],
            'settings' => ['username', 'email', 'password','gender','address'],
        ]);
    }
